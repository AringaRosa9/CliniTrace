"""Versioned management and independently reviewed quality loop."""

from alembic import op

from migrations.s4_schema import s4_tables

revision = "0007_quality"
down_revision = "0006_reviews_exports"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    for table in reversed(s4_tables):
