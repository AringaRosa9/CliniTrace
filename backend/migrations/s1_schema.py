...
from app.db.models import metadata as base_metadata

metadata = MetaData(naming_convention=base_metadata.naming_convention)
for name in ("tenants", "projects", "patients", "encounters"):
    base_metadata.tables[name].to_metadata(metadata)
